...
<EvaluationCriteriaCounter
  criteriaWithCoefficients={[
    ...
    {
      criterion: "Successful implementation of layouts, with special attention to the Cart and Checkout pages",
      coefficient: 20,
    },
    { criterion: "Functional navigation", coefficient: 15 },
    {
      criterion: "Judicious use of Storefront UI components, understanding some may need custom development",
      coefficient: 5,
    },
  ]}
/>
